...
public class writebroad extends JFrame implements MouseListener, ActionListener {
	...
	JMenuItem newfile, open, save, othersave, exit, jianqie, fuzhi, zhantie, shanchu, chazhaoxia, swap, zhuandao,
			tongji, allselect, time, findall, autohuanhang, ziti, zhuangtai, chakanbanzhu, guanyu, zidingyicolor,
			xuanzebeijing, chuizhi, shizhijia, moren, shoushi, shuipin;
