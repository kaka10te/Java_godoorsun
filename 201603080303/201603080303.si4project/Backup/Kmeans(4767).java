...
public class Kmeans {
	...
	private ArrayList<StudentSubmission> dataSet;// 数据集链表
	private ArrayList<ArrayList<StudentSubmission>> center;// 中心链表
	private ArrayList<ArrayList<StudentSubmission>> cluster; // 簇
	...
	private void init() {
		...
		center = initCenters();
		cluster = initCluster();
		jc = new ArrayList<StudentSubmission>();
	}
	 ...
	 * @return 距离
	 */
	private long distance(long element, long center) {

		long distance = Math.abs(element - center);
	 ...
	 */
	private long minDistance(long[] distance) {
		long minDistance = distance[0];
		int minLocation = 0;
