...
public class TestComplexLayout {
	...
	static JFrame f = new JFrame("JFrame with ComplexLayout");
	...
	private static void initComponents() {
		...
		JButton[] btn = { new JButton("确定"), new JButton("取消"), new JButton("设置..."), new JButton("帮助") };
		int i;
		...
		JRadioButton[] rb = { new JRadioButton("所选区域"), new JRadioButton("全部", true), new JRadioButton("Applet") };
		...
		try {
			// 以下风格简称Nimbus
			String lfClassName = "javax.swing.plaf.nimbus.NimbusLookAndFeel";
